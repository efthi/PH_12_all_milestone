...
| `git checkout -b [branch name]` | একটি নতুন ব্রাঞ্চ তৈরি করুন এবং সেটায় সুইচ করুন |
| `git checkout -b [branch name] origin/[branch name]` | রিমোট ব্রাঞ্চ ক্লোন করুন এবং এটিতে সুইচ করুন |
...
| `git stash clear` | স্ট্যাশ এন্ট্রিগুলো সরিয়ে ফেলুন |
